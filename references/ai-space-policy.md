...
- Phạm vi Google Drive mặc định để tạo file mới là **My Drive** của tài khoản Google đang kết nối, tương ứng giao diện `https://drive.google.com/drive/u/1/my-drive` khi dùng đúng tài khoản của anh Hưng.
...
- Root AI_Space chính thức là Google Drive folder ID `1kO9wbjTqSxB-NDLSZqfGuRHwc-Eqkmee`.
...
| `01_Development/projects/` | Hồ sơ phát triển, audit và bàn giao |
| `01_Development/releases/` | Gói phát hành sinh từ phiên bản xác định |
| `02_Workspace/projects/` | Workspace viết báo cáo theo dự án và giai đoạn |
...
- Chọn workspace theo project ID và report hoặc stage. Nếu không xác định được từ inventory, hỏi đúng phần còn thiếu và không tự tạo dự án trùng.
